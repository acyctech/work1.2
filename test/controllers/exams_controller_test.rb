...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { answer: @exam.answer, category: @exam.category, question: @exam.question } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { answer: @exam.answer, category: @exam.category, question: @exam.question } }
